...
{
    public partial class FrmCRUD_Gestion_Ac_Load : Form
    {
        //Variables to update parent form
        private FrmCreate_AcademicLoad _frmAcademicLoad;
        private FrmCRUD_Gestion_Ac_Load _frmCRUD_Gestion;
        ...
        public static string ActividadType = "Gestion";
        private FrmCUActividad_AL formHijoActividad;
        private CN_CargaHoraria objetoCNegocio = new CN_CargaHoraria();

        public FrmCRUD_Gestion_Ac_Load(int idAcLoad)
        {
            InitializeComponent();
        ...
        private void FrmCRUD_Gestion_Ac_Load_Load(object sender, EventArgs e)
        {
            MostrarRegistros();
        }
        public void MostrarRegistros()
        {
            ...
            dgLstRegistros.DataSource = objetoCNegocio.LoadActividadesG_Negocio(idAcLoadLocal.ToString());
