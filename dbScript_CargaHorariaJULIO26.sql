...
('FUNDAMENTOS DE COMPUTACIÓN EN LA NUBE', 'Modular', 'MPTI124', 64, 8, 'Master Primer Nivel',1),
('PROGRAMACIÓN PARA MANIPULACIÓN DE DATOS', 'Modular', 'MPTI143', 48, 6, 'Master Primer Nivel',1),
...
('APRENDIZAJE AUTOMÁTICO APLICADO', 'Modular', 'MPTI243', 64, 8, 'Master Segundo Nivel',1),
('SEGURIDAD EN ENDPOINTS', 'Modular', 'MPTI224S', 64, 8, 'Segundo Nivel',1),
('MONITOREO Y DETECCIÓN DE INTRUSIÓN DE REDES', 'Modular', 'MPTI242S', 64, 8, 'Master Segundo Nivel',1),
('APLICACIONES PARA INTERNET DE LAS COSAS', 'Modular', 'MPTI234', 64, 8, 'Master Segundo Nivel',1),
('TÓPICOS DE PLANIFICACIÓN Y REGULACIÓN EN TI', 'Modular', 'MPTI213', 48, 6, 'Master Segundo Nivel',1),
('TÉCNICAS DE HACKING', 'Modular', 'MPTI233S', 32, 4, 'Master Segundo Nivel',1),
('TRABAJO DE TITULACIÓN /EXAMEN COMPLEXIVO', 'Semestral', 'MPTI253', 0, 0, 'Master Segundo Nivel',1),
--TICs Maestria II
('MODELOS DE NEGOCIOS EN LOS ECOSISTEMAS IOT', 'Modular', 'MPTI222', 32, 4, 'Master Segundo Nivel',1),
('APRENDIZAJE AUTOMÁTICO APLICADO', 'Modular', 'MPTI243', 64, 8, 'Master Segundo Nivel',1),
...
('TRABAJO DE TITULACIÓN /EXAMEN COMPLEXIVO', 'Semestral', 'MPTI253', 0, 0, 'Master Segundo Nivel',1),
--TELE Maestria I
('PROBABILIDAD Y ESTADÍSTICA', 'Semestral', 'MITR-113', 144, 3, 'Master Primer Nivel',1),
('PROCESAMIENTO DE SEÑALES', 'Semestral', 'MITR-123', 144, 3, 'Master Primer Nivel',1),
('RADIO FRECUENCIA', 'Semestral', 'MITR-133', 144, 3, 'Master Primer Nivel',1),
('HERRAMIENTAS DE SIMULACIÓN E IMPLEMENTACIÓN EN HARDWARE', 'Semestral', 'MITR-143', 144, 3, 'Master Primer Nivel',1),
('METODOLOGÍA Y DOCUMENTACIÓN CIENTÍFICA', 'Semestral', 'MITR-153', 144, 3, 'Master Primer Nivel',1),
('PROCESAMIENTO AVANZADO DE SEÑALES', 'Semestral', 'MITR-213', 144, 3, 'Master Segundo Nivel',1),
('TÉCNICAS AVANZADAS DE COMUNICACIONES', 'Semestral', 'MITR-224', 192, 4, 'Master Segundo Nivel',1),
('ESTUDIO DEL CANAL INALÁMBRICO Y TÉCNICAS DE MITIGACIÓN', 'Semestral', 'MITR-233', 144, 3, 'Master Segundo Nivel',1),
('COMUNICACIONES MÓVILES DE BANDA ANCHA', 'Semestral', 'MITR-243', 144, 3, 'Master Segundo Nivel',1),
